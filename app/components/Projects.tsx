  ...
  <div className='px-1'> 
    <div className='flex flex-col md:flex-row md:items-start justify-between'>
      <div className=' md:w-[60%] md:-mr-20 md:z-30'>
          ...
          <p className='w-full py-4 px-3 md:px-5 mx:py-6 text-xs text-black tracking-widest bg-secondary rounded-xl mt-3 mb-4'>
              {description}
          </p>
      </div>
              
      <div className='relative h-44 md:min-w-[50%]'>
    ...
    <div className='flex gap-4 text-gray-400 mt-2 md:-mt-4'>
...
const Projects = () => {  
  return (
    <div className='min-h-screen md:min-h-[60vh] flex flex-col justify-center'>
