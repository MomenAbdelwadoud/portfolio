...
const Header = () => {
  return (
    <header className='py-20 md:py-36 flex flex-col md:items-center'>
    <div>
      ...
      <h1 className='text-2xl tracking-wide mb-3 font-medium md:text-3xl'>MOMEN ABD-ELWADOUD</h1>
      ...
      width={80}
      height={80}
      className="absolute animate-spin right-10 bottom-1/2 md:w-[150px] md:h-[150px] md:right-0 md:left-10"
      ></Image>
    </div>
  </header>
  )
